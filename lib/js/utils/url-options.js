 ...
 *   ?lang=en|ar           interface language (and, for Arabic, a right-to-left interface)
 ...
 * except the theme, the language and the reading direction, which are user preferences.
 */
(function () {
    ...
    /*
     * i18n.js reads `options.lang` while it boots, so the first paint is already in the right
     * language; this runs again on zaya:init for the case where the module loaded before it.
     */
    function applyLanguage() {
        if (!options.lang || !window.ZayaI18n) return;
        if (window.ZayaI18n.lang !== options.lang) window.ZayaI18n.setLanguage(options.lang);
    }
