...
/**
 * Layout-based single-page decision: a narrow or portrait viewport cannot show a
 * readable two-page spread, whatever the user agent says.
 */
export const prefersSinglePage = (width, height) =>
  width > 0 && (width < 700 || (height > 0 && width < height * 0.95));
