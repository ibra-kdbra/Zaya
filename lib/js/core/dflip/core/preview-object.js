...
export class PreviewObject {
  ...
  resize() {
    ...
    // Width of the Navigator drawer when it pushes the book (desktop); phones overlay instead
    ...
    const sideMenuWidth = container.hasClass("df-sidemenu-open") && containerWidth > 640 ? drawerWidth : 0;
