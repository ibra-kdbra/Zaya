...
window.ZayaNavigator = (function () {
    ...
    function init() {
        ...
        document.addEventListener("click", (e) => {
            ...
            const tabBtn = target.closest("#navigatorDrawer [data-nav-tab]");
            ...
            if (target.closest("#navigatorDrawer, #customControlBar, #appHeader, .modal-container, .theme-modal, #unifiedPanel")) return;
            close();
        });
        ...
        document.addEventListener("keydown", (e) => {
            const tabBtn = e.target && e.target.closest ? e.target.closest("#navigatorDrawer [data-nav-tab]") : null;
            if (!tabBtn) return;
