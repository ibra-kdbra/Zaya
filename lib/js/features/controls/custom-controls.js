$(document).ready(function () {
    ...
    function syncUI() {
        ...
        if (fb) {
            ...
            // Document meta shown in the control panel header
...
window.ZayaNavigator = (function () {
    ...
    const EMPTY = {
        thumbs: "Page thumbnails are still being prepared.",
        outline: "This document has no outline.",
        search: "Search is not available for this document."
    };
    ...
    function updateEmptyState() {
        ...
        let message = "";
        if (!p) message = EMPTY[activeTab];
        else if (activeTab === "outline" && !p.querySelector(".df-outline-item")) message = EMPTY.outline;
        else if (activeTab === "thumbs" && !p.querySelector(".df-vrow")) message = EMPTY.thumbs;
