...
ThemeSelectorModal.prototype.createModal = function () {
    ...
    modalWrapper.setAttribute('aria-label', 'Theme');

    modalWrapper.innerHTML = `
        <div class="tm-modal-content">
            <div class="tm-modal-header">
                <h2 class="tm-title" id="tmTitle">Theme</h2>
                <div class="tm-search-container">
                    <i class="fas fa-search tm-search-icon" aria-hidden="true"></i>
                    <input type="text" class="tm-search-input" placeholder="Search themes" spellcheck="false" aria-label="Search themes" aria-controls="themeGrid">
                </div>
                <button type="button" class="tm-close" aria-label="Close theme picker">
                    <i class="fas fa-times" aria-hidden="true"></i>
                </button>
            </div>
            <div class="tm-modal-body" id="themeGrid" tabindex="0" role="listbox" aria-labelledby="tmTitle"></div>
        </div>
    `;
