...
async function loadApplication() {
    try {
        // 1. Vendored libraries. The engine brings its own three.js and pdf.js as ES modules
        //    (vendor/three, vendor/pdfjs) and imports them itself, so neither is listed here.
        await loadInOrder([
