...
// Only binary assets that never change between commits (everything vendored, images, sounds) are served from
...
function isImmutable(url) {
  return /\/(vendor|images|sound)\//.test(url.pathname);
}
